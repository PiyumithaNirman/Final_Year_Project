...
for movieName in movie_list:
    ...
    Movie_director_awords.apped(director_aword)
    ...
    Movie_costume_name.append(costume_aword)
...
data = list(zip(Movie_Names, Movie_years, Movie_ratings, Movie_director, Movie_director_credit, Movie_director_awords,
                ...
                Movie_cinematography_aword, Movie_costume_name, Movie_costume_credit, Movie_costume_aword))
...
df = pd.DataFrame(data,
                  columns=['Movie_Names', 'Movie_years', 'Movie_ratings', 'Movie_director', 'Movie_director_credit',
                           ...
                           'Movie_costume_name', 'Movie_costume_credit', 'Movie_costume_aword'])
