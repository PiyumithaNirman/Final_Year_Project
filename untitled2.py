...
for movieName in movie_list:
    ...
    director_name, actor_1_name, actor_2_name, actor_3_name, writter_name, music_name, cinematography_name, costume_name, director_credit, actor_1_credit, actor_2_credit, actor_3_credit, writter_credit, music_credit, cinematography_credit, costume_credit, actor_1_aword, actor_2_aword, actor_3_aword, director_aword, writter_aword, music_aword, cinematography_aword, costume_aword = getmovieactor(movie_id)
